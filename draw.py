...
@contextmanager
def create_canvas_render(width, height,x,y, filename="output", font_size=5, dry=False):
    ...
    data = dict(direction=0, points=[context.user_to_device(*context.get_current_point())])
